...
video_path = 'C:/Users/main/workspace/vision/2025-06-16/imgs/slow_traffic_small.mp4'
print(os.path.exists(video_path))  # → True 여야 함

cap=cv.VideoCapture(video_path)

if not cap.isOpened():
    print(f"❌ Video 파일 열기 실패: {video_path}")
    exit()
